<?php
    ...
    if(isset($_POST['language'])) {
        $mail = substr(htmlspecialchars(trim($_POST['language'])), 0, 100);
        $mess .= '<b>Мова:</b>' . $mail . '<br>';
    }
    $mess .= '<hr>';
    ...
    $mail = new PHPMailer();
    $mail->AddAddress('aupairkhmelnytsky@ukr.net','');   // кому - адрес, Имя
